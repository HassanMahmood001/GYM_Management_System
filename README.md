...
This project is about a gym management system. The gym management system has a login portal and a user need a username and a password for accessing the system. The system records all the information of trainers and the trainees who are involved with the gym. It also keeps the track of all the exercises a trainee is supposed to do, and a trainer is supposed to look after. It is a proper system and should work as a good gym management system.

# Features
* Secure Login System
* Smooth Registration System
* Display of information correctly
* Proper menu displaying all options
* Proper schedule of exercises
* Trainer and trainee record
* Program Termination controlled by user 
